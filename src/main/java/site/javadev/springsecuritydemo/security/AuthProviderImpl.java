...
public class AuthProviderImpl implements AuthenticationProvider {
    ...
    private final site.javadev.springsecuritydemo.security.PersonDetailsService personDetailsService;

    @Autowired
    public AuthProviderImpl(site.javadev.springsecuritydemo.security.PersonDetailsService personDetailsService) {
